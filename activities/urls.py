...
from .views import home,select_child,add_child,logout_view,select_activity,delete_child, start_activity, stop_activity, child_report
urlpatterns = [
    ...
    path('child-report/<int:child_id>/', child_report, name='child_report'),  # New URL for activity report
