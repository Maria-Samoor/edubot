...
from .views import home,select_child,add_child,logout_view,select_activity,delete_child, start_activity, stop_activity, activity_report
urlpatterns = [
    ...
    path('activity-report/<int:child_id>/', activity_report, name='activity_report'),  # New URL for activity report
